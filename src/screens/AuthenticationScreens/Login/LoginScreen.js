        ...
        <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                <View style={{ marginTop: "10%" }}>
                    <Button onPress={() => navigation.navigate('SonFormData')} title="تسجيل الدخول" TextColor={Colors.white} backgroundColor={Colors.primary} />
                    <View style={styles.orContainer}>
                        <View style={styles.line} />
                        <Text style={styles.or}>أو</Text>
                        <View style={styles.line} />
                    </View>
                    <Button onPress={() => navigation.navigate('SignUp')} title="تسجيل حساب جديد" TextColor={Colors.primary} borderColor={Colors.primary} borderWidth={1} />
                </View>
