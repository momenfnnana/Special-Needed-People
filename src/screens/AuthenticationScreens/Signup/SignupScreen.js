...
const SignUp = ({ navigation }) => {
    ...
    const toggleAgreeButton = () => {
        agreeButton === Colors.white ? setAgreeButton(Colors.primary) : setAgreeButton(Colors.white)
    }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                <TouchableOpacity onPress={toggleAgreeButton} style={styles.agreeContainer}>
                    <View style={styles.agreeCircleContainer}>
                        <View style={[styles.agreeCircle, { backgroundColor: agreeButton }]} />
                    </View>
                    <Text style={styles.agree}>أوافق على كافة الشروط والأحكام</Text>
                </TouchableOpacity>
                <Button onPress={() => navigation.goBack()} title="تسجيل حساب جديد" TextColor={Colors.white} backgroundColor={Colors.primary} />
                <View style={styles.orContainer}>
                    <View style={styles.line} />
                    <Text style={styles.orText}>أو</Text>
                    <View style={styles.line} />
                </View>
                <Button onPress={() => navigation.navigate('SonFormData')} title="تسجيل الدخول" TextColor={Colors.primary} backgroundColor={Colors.white} borderColor={Colors.primary} borderWidth={1} />
            </View>
        </View>
    )
}
